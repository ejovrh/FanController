 ...
 * @brief        This file provides code for the MSP Initialisation
	...
	if(hadc->Instance == ADC1)
		{
			...
			/**ADC GPIO Configuration
			 ...
			 PA4     ------> ADC_IN4
			 */
			GPIO_InitStruct.Pin = TEMP1_SIGNAL_Pin | TEMP2_SIGNAL_Pin | TEMP3_SIGNAL_Pin;
	...
	if(hadc->Instance == ADC1)
		{
			...
			/**ADC GPIO Configuration
			 ...
			 PA4     ------> ADC_IN4
			 */
			HAL_GPIO_DeInit(GPIOA, TEMP1_SIGNAL_Pin | TEMP2_SIGNAL_Pin | TEMP3_SIGNAL_Pin);
